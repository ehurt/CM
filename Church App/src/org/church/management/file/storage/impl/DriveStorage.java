...
public class DriveStorage implements FileStorage
{
	private static final Logger logger = Logger.getLogger(DriveStorage.class);
	...
	public DriveStorage(Properties properties)
	{
