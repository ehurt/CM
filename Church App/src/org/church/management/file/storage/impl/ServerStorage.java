 ...
 */
public class ServerStorage implements FileStorage
{
	private static Logger logger = Logger.getLogger(ServerStorage.class);
	...
	public ServerStorage(Properties properties)
	{
