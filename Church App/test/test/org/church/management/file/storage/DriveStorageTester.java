...
import org.church.management.file.storage.impl.DriveStorage;
import org.church.management.file.storage.impl.ServerStorage;
import org.junit.Test;

public class DriveStorageTester 
{
	...
	public void testCreateDirectory() throws Exception
	{
		...
		Properties bundle = Configuration.getResourceBundle();
		bundle.setProperty("storagePath", "C:/Test");
		FileStorage storage = (FileStorage) fileStorageClass.getConstructor(Properties.class).newInstance(bundle);
	...
	public void testRenameDirectory() throws Exception
	{
		...
		String directoryPath = storage.createDirectory("User_1_200207");
		
		String directoryPath2 = storage.renameDirectory(directoryPath, "User_1_200205");
	...
	public void testZipUp() throws Exception
	{
		...
		filepath = storage.copy("User_1_200203", "states.properties", file);
		...
		String finalPath = storage.copy("User_1_200202","hibernate.cfg.xml", countryfile);
	
		file = new File(finalPath);
		
		System.out.println("Final Path "+finalPath);
		
		File archive = storage.zipUpAllFiles("DriverFolder.zip");
		
		System.out.println("Archive Path "+archive.getAbsolutePath());
	}
	
	@Test
	public void testZipUpDirectory() throws Exception
	{
		Class fileStorageClass = Configuration.getClass("fileStorage", ServerStorage.class);
		fileStorageClass = DriveStorage.class; 
		Properties bundle = Configuration.getResourceBundle();
